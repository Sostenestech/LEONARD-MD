8const { zokou } = require("../framework/zokou");
...
zokou({ nomCom: 'uptime',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_𝗟𝗲𝗼𝗻𝗮𝗿𝗱 𝗠𝗗 has been up for: ${runtime(process.uptime())}_*`) 
...
await zk.sendMessage(dest, { image: res, caption: '𝑾𝒆𝒃 𝑺𝒄𝒓𝒆𝒆𝒏𝒔𝒉𝒐𝒕 𝒃𝒚 *Leonard*'}, { quoted: ms });
